...
public class Glavna
{
    public static void work(SLL<Task> toDo, SLL<Task> inProgress) {
        ...
        SLLNode<Task> other = inProgress.getFirst();
        SLLNode<Task> pom = null;
        int max = 0;

        while(curr!= null){
            int priority = curr.element.getHours() * curr.element.getPriority() * 2;
            if(max < priority){
                max = priority;
                pom = curr;
            }
        ...
        toDo.delete(pom);
        inProgress.insertFirst(pom.element);

        int min = 9999;
        SLLNode<Task> pom1 = null;
        while(other != null){
            int prior =  other.element.getHours() * other.element.getPriority() *2;
            if(min > prior){
                min = prior;
                pom1 = other;
            }
        ...
        inProgress.delete(pom1);
        toDo.insertLast(pom1.element);
